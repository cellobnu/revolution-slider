...
class MT_RevSlider_Adminhtml_SliderController extends Mage_Adminhtml_Controller_Action{

    private $resourceName = '';

    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')->isAllowed('mt/revslider/'.$this->resourceName);
    }

    public function _initAction(){
        $this->loadLayout()->_setActiveMenu('mt/revslider');
        $this->_title(Mage::helper('revslider')->__('MT Extensions'));
        return $this;
    }

    public function indexAction(){
        $this->resourceName = 'manager';
        $this->_initAction();
    ...
    public function editAction(){
        ...
        $this->_initAction();
        Mage::helper('mtext')->loadJsLibs(array('jscolor', 'browser', 'codemirror'));
        $this->_title(Mage::helper('revslider')->__('Manage Slider'));
    ...
    public function importAction(){
        $this->resourceName = 'import';
        $this->_initAction();
        $this->_setActiveMenu('mt/revslider');
        ...
        if ($this->getRequest()->isPost()){
            try{
                ...
                if ($slider->getId()) {
                    ...
                    /* @var $helper MT_RevSlider_Helper_Data */
    ...
    protected function _processZipImport($filePath){
        ...
        if ($sliderData !== false){
            ...
            /* @var $cssParser MT_RevSlider_Helper_Css */
            ...
            if (is_array($cssArray)){
                foreach ($cssArray as $cssRule => $cssProperties){
                    ...
                    /* @var $cssModel MT_RevSlider_Model_Css */
        ...
        if ($animationData !== false){
            ...
            if ($animationArray !== false && is_array($animationArray)){
                foreach ($animationArray as $animation){
                    ...
                    /* @var $animationModel MT_RevSlider_Model_Animation */
