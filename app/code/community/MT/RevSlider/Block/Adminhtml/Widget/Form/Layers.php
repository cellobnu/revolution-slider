...
class MT_RevSlider_Block_Adminhtml_Widget_Form_Layers
    ...
    public function __construct(){
        parent::__construct();
        $this->setTemplate('mt/revslider/widget/form/layers.phtml');
    }
    ...
    protected function _prepareLayout(){
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button',
            ...
            'onclick'   => sprintf('MT.MediabrowserUtility.openDialog(\'%s\', \'addLayerImageWindow\', null, null, \'%s\')',
        ...
        $addLayerBtn = $this->getLayout()->createBlock('adminhtml/widget_button',
            ...
            'onclick'   => sprintf('MT.MediabrowserUtility.openDialog(\'%s\', \'addLayerVideoWindow\', null, 700, \'%s\')',
